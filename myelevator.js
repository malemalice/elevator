...
// Main Algorithm
// when elevetor up, it deliver people sorted asc
// when elevetor down, it deliver people sorted desc
...
Elevator.prototype.decide = function() {
    ...
    function allow_handle(a, requests, elevators) {
            ...
            if (elevator.direction == 'up') {
                ...
                for (a = elevator.at_floor(); a <= num_floors; a++) {
                    if (people.length < Config.elevator_capacity) {
                        if (allow_handle(a, requests, elevators)) {
